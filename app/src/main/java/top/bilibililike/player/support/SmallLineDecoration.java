package top.bilibililike.player.support;
...
public class SmallLineDecoration extends RecyclerView.ItemDecoration {
    private static int dividerColor = Color.parseColor("#21333333");//分割线的颜色
     ...
     */
    private int mMarginStart = 0, mMarginEnd = 0;


    public SmallLineDecoration() {
        this(1);
    }

    public SmallLineDecoration(float dividerSize) {
        this(dividerSize, dividerColor);
    }

    public SmallLineDecoration(Drawable drawable) {
        this(drawable, 1);
    }

    public SmallLineDecoration(float dividerSize, int dividerColor) {
        mDividerSize = dividerSize;
        mDividerDrawableV = new ColorDrawable(dividerColor);
        mDividerDrawableH = mDividerDrawableV;
    }

    public SmallLineDecoration(Drawable drawable, int dividerSize) {
        mDividerSize = dividerSize;
    ...
    public static void setDividerColor(int dividerColor) {
        SmallLineDecoration.dividerColor = dividerColor;
    }
