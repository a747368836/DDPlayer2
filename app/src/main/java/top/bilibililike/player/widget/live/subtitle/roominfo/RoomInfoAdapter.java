...
public class RoomInfoAdapter extends RecyclerView.Adapter<RoomInfoAdapter.ViewHolder> {
    ...
    private ItemClickedCallback clickCallback;

    public RoomInfoAdapter(ItemClickedCallback callback){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindItem(RepoBean.DataBean dataBean){
            ...
            itemView.setOnClickListener( v -> clickCallback.onItemClicked(roomInfoBean.getRoom_id()+""));
            Glide.with(itemView)
    ...
    public interface ItemClickedCallback {
         ...
         * 点击监听回调
         */
        void onItemClicked(String roomId);
    }
}
